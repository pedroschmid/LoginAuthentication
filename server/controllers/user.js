// Controller para listar usuarios
        ...
        if(req.body.username && req.body.password){
            if(req.body.password2 && req.body.password == req.body.password2){
                ...
                .then(user => {
                    ...
                    if(user){
                        res.json({ success: false, message: 'This username isnt avaliable!'})
                    } else {
                        ...
                        .catch(err => res.json({ success: false, message: err, statusCode: 400}))
                    }
                })
            } else {
                
                res.json({ success: false, message: 'Password doesnt match!', statusCode: 400})
            }
        } else {
